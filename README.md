...
| 직업 | ✚ 힐 | ⚔ 딜 | ☠ 포스 | 🏃 이동기 |
|---|---|---|---|---|
| ⛏ 광부 | 대지의 축복 — 회복+채굴속도 버프 | 낙석 — 광역 피해+둔화 | 지진 — 광역 넉업+강한 슬로우+시야 뿌옇게(진탕) | (준비 중, 임시 대시) |
| 🌾 농부 | 수확의 축복 — 팀원까지 광역 회복 | 가시덩굴 — 광역 중독 | 뿌리 속박 — 강한 둔화+약화 | (준비 중, 임시 대시) |
| ⚔ 전사 | 전투 의지 — 자힐+저항 버프 | 돌격 — 전방 돌진하며 이동 경로의 적 전부 피해+넉백 | 포효 — 넓은 범위 약화 | (준비 중, 임시 대시) |
| 🎣 어부 | 만조 — 재생(지속 회복) | 작살 — 단일 대상 피해+끌어당김 | 파도 — 광역 강한 넉백 | (준비 중, 임시 대시) |
